...
import com.example.samplemvc.noteView.DrawingView;
import com.example.samplemvc.noteView.StatusTextView;
import com.example.samplemvc.noteView.StrokeManager;
import com.example.samplemvc.noteView.StrokeManager.DownloadedModelsChangedListener;
...
public class NoteActivity extends AppCompatActivity
    ...
    private ArrayAdapter<ModelLanguageContainer> populateLanguageAdapter() {
        ...
        languageAdapter.add(ModelLanguageContainer.createLabelOnly("言語を選択する。"));

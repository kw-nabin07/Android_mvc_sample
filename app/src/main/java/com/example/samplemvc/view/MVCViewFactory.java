...
public class MVCViewFactory {
    ...
    public enum VIEW_TYPE{
        MAIN_VIEW_TYPE, MANIPULATION_VIEW_TYPE,SHOW_TODO_VIEW_TYPE,TODO_REGISTER_VIEW_TYPE,CALENDER_VIEW_TYPE
    }
    public static MVCView getMVCView(VIEW_TYPE viewType, Context context, ViewGroup viewGroup, Intent intent){
        ...
        switch (viewType){
            ...
            case CALENDER_VIEW_TYPE: mvcView = new CalenderViewImplementor(context, viewGroup); break;
